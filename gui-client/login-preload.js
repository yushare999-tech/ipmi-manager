...
(function() {
  ...
  function attemptLogin() {
    ...
    const userSelectors = {
      ...
      hp: ['#usernameInput', '#inputUser', '#username', 'input[name="username"]', 'input[autocomplete="username"]', 'input[type="text"]'],
      supermicro: ['input[name="name"]', 'input[name="username"]', 'input[type="text"]'],
      generic: ['input']
    };
    const passSelectors = {
      dell: ['#password', 'input[name="password"]', 'input[type="password"]'],
      hp: ['#passwordInput', '#inputPass', '#password', 'input[name="password"]', 'input[autocomplete="current-password"]', 'input[type="password"]'],
  ...
  function submitForm(activeEl, vendor) {
    const submitBtnSelectors = {
      ...
      hp: ['#ID_LOGON', '#login_button', 'button[type="submit"]', '#btn-login', '.btn-primary', 'input[type="submit"]'],
